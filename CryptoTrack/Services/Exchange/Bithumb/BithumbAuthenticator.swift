...
// MARK: - Bithumb JWT Authenticator

/// Bithumb API 2.0 인증을 위한 JWT 토큰을 생성합니다.
/// 빗썸은 2024년 이후 Upbit과 동일한 JWT(HS256) 인증 방식을 사용합니다.
...
struct BithumbAuthenticator: Sendable {
    ...
    /// Bithumb API 요청에 필요한 Bearer JWT 토큰을 생성합니다.
    /// - Parameter queryHash: 요청 파라미터의 SHA-512 해시 (파라미터 없는 요청은 nil)
